...
def registration(request):
    if request.method == "POST":
        ...
        if not (fn and ln and pn and lc and em and pwd and cpwd):
            messages.error(request, 'All fields are required.')
            return render(request, 'registration.html', {'error': 'yes'})
        ...
        try:
            ...
            return render(request, 'registration.html', {'error': 'no'})
